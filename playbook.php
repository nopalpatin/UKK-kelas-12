  ...
  tasks:
    ...
    - name: Configure wp-config.php
      lineinfile:
        ...
        line: "{{ item.line }}"
      loop:
        - { regexp: "DB_NAME", line: "define('DB_NAME', 'cyber23');" }
        - { regexp: "DB_USER", line: "define('DB_USER', 'cyber');" }
        - { regexp: "DB_PASSWORD", line: "define('DB_PASSWORD', 'pass2023');" }
  ...
  tasks:
    ...
    - name: Clone blog repository
      git:
        ...
        dest: /var/www/cyber23
    - name: Import SQL file into database
      mysql_db:
        name: cyber23
        state: import
        target: /var/www/cyber23/db.sql
        login_user: cyber
        login_password: pass2023
